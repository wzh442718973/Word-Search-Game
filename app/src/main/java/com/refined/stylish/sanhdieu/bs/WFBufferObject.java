...
public final class WFBufferObject {
private float stateBackCommand_padding = 0.0f;
private ArrayList<Integer> wifiListenerStat_list;
boolean is_PreferencesUseItem = false;
private float handlerNameContent_max = 0.0f;
    ...
    public static WBufferRectangle dump(Object obj) {
        return new WBufferRectangle.CCWLine(obj, 1, 1);
    }

    public static WBufferRectangle dump(Object obj, int superDepth, int depth) {
        return new WBufferRectangle.CCWLine(obj, superDepth, depth);
    }
