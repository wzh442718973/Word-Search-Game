...
public final class KWAdapter extends EOInitZoom<Field> {
int adapterVersionMark = 0;
float preferenceRoundsSize = 0.0f;



    public static KWAdapter Get(Class clszz, String fieldName) {
        Field field = null;
        try {
        ...
        return new KWAdapter(clszz, field);
    }

    public KWAdapter(Class clszz, Field field) {
        super(clszz, field);
    }
