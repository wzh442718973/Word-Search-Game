...
public class RAJNotificationPack {
double class_4vDumpUnlock_offset = 0.0;
private double wifiPlayBinder_min = 0.0;
private HashMap<String,Double> runnableIntentCase_oyDictionary;
